...
<html>
	...
	<body>
							...
							<div class="row">
								...
								<div class="col-md-9 main-nav">
									<ul class="nav text-right">
										...
										<li class="active"><a href="viewenquiry.php">View enquiries</a></li>
		...
		<div class="table-responsive container" style="border:5px solid black; align:center; margin:0px auto;">
			<table class="table">
				<thead><tr><th>Name</th><th>Father's Name</th><th>Course Id</th><th>Mobile</th><th>Email</th></tr><thead>
					<?php
						require'db.php';
						...
						{   
							echo "<tr><td>" . $row['Name'] . "</td><td>"  . $row['Email'] .. $row['Message'] "</td></tr>"; echo"<br>";  
						}
					?>
			</table>
		</div>	
